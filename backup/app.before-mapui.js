...
${labVocabText()}`;
  ...
  function loadLabels() {
    ...
    try { const v = JSON.parse(localStorage.getItem(LABEL_KEY)); labelsCache = v && typeof v === 'object' ? v : {}; } catch (e) { labelsCache = {}; }
    return labelsCache;
  }
  function saveLabels() {
    try { localStorage.setItem(LABEL_KEY, JSON.stringify(labelsCache || {})); } catch (e) { /* โควตาเต็ม */ }
  }
